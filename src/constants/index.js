...
export const skillText= [
    {
        title:"이승남 꿈을 설계하다.",
        desc:"꿈을 이루기 위해 필요한 기술과 지식을 향상시키기 위해 꾸준한 연습과 학습을 통해 경험을 쌓습니다.실패를 두려워하지 않고 그로부터 배움을 얻는 자세를 가집니다.꿈을 이루기 위한 동기부여를 유지하고 향상시키기 위해 자기계발에 투자합니다."
    },
    {
        title:"나는 생각한다. 열심히 할수록 기회는 따른다.",
        desc:"열심히 노력하면 성과에 비례해 기회가 찾아온다.노력은 성공의 열쇠이며, 인내와 투지는 미래의 발전을 약속한다.기회는 끊임없이 노력하는 이에게 미소를 짓는다."
    },
    {
        title:"이승남 나에게 정직하다.",
        desc:"자기 자신에게 정직하다는 것은 솔직하게 자아를 인식하고, 강점과 약점을 인정하는 것입니다. 과거의 실수를 부끄럽게 여기지 않고 배우며, 더 나은 미래를 향해 솔선수범하는 자세를 취하는 것이 중요합니다."
    }
]
